    ...
    <>
      <div className="p-2 bg-[#F6F9FA] rounded-xl overflow-hidden border border-[#E6F0F8]">
        ...
        <div className="pt-4 pl-2">
          ...
          />
          <span className="pt-2 font-inter font-semibold text-[0.875rem] leading-[1.25rem] text-[#000005] flex-none order-0 self-stretch grow-0">
            {name}
          </span>
          <span className="py-2 font-inter font-normal text-[0.75rem] leading-[1rem] text-[#757B80] flex-none order-1 self-stretch grow-0">
            {uses}
          </span>
        </div>
      </div>
